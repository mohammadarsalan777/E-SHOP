        ...
        <footer className="style-2">
            <div className='footer-top dark-view padding-tb '>
                <div className="container">
                    ...
                    <div className="row row-cols-xl-4 row-cols-md-2 row-cols-1 g-4 justify-content-center ">
                        <div className="col">
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2023 <Link to={'/'}>Shopcart</Link> designed by <a href="/" target='_blank'>ARS</a></p>
